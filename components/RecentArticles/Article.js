...
export default function Article(props) {
  const {title} = props
  return (
    <div className='recent__article transform duration-300 absolute top-auto left-0 w-1/3 m-auto h-auto flex flex-col text-left border border-slate-900 dark:bg-white rounded'>
