...
export default function Footer() {
  return (
    <div className="relative flex md:flex-row  sm:flex-col gap-5 !h-96 mt-12 border-grey border-t-[2px]">
      ...
      <div className=" w-1/2 mt-12 pl-24 flex flex-row gap-24 justify-start border-slate-900 sm:border-t-[1px] sm:border-l-0 md:border-l-[1px] md:border-t-0">
